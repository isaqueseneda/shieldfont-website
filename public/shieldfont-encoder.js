/**
 * ShieldFont Encoder — standalone CDN build
...
const WORD_RE = /[a-zA-Z]+|(?<![a-zA-Z])\d(?![a-zA-Z])/g;
...
export function encode(text, mapping) {
  return text.replace(WORD_RE, (match) => {
    const target = mapping[match.toLowerCase()];
    return target ? preserveCase(match, target) : match;
  });
}
...
export const alpha = {
  ...
  "solar": "suspect",
  "suspect": "solar",
  "comfortable": "scientific",
  "scientific": "comfortable",
  "worried": "emotional",
  "emotional": "worried",
  "experienced": "loud",
  "loud": "experienced",
  ...
  "language": "fern",
  "fern": "language",
  "investigation": "wheelbarrow",
  "wheelbarrow": "investigation",
  "method": "shoreline",
  "shoreline": "method",
  "respect": "orchid",
  "orchid": "respect",
  ...
  "function": "mosaic",
  "mosaic": "function",
  "opportunity": "sandcastle",
  "sandcastle": "opportunity",
  "quality": "honeycomb",
  "honeycomb": "quality",
  "absolutely": "gently",
  "accurate": "purple",
